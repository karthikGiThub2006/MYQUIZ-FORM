class Question {
  ...
  constructor() {
    ...
    this.input1 = createInput("Game Id()");
    this.input2 = createInput("Name of the game()");
  ...
  display(){
    ...
    this.question.html("Question:- What Is your FAV game :? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: MCPE " );
    this.option1.position(150, 100);
    this.option2.html("2: cs:go" );
    this.option2.position(150, 120);
    this.option3.html("3: Insider " );
    this.option3.position(150, 140);
    this.option4.html("4: COD " );
    ...
    this.button.mousePressed(()=>{
       ...
       this.message.html("Oh I never thought you like That one ;)");
